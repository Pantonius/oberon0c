...
//             NodeType::ident_pattern) {
//           // "ELSE"
//           cases->at(case_index).first->accept(*this); // visit
//           IdentPatternNode auto ident_pattern = dynamic_cast<const
//           IdentPatternNode *>(
...
//     //   }
//     //
//     //   value_ = builder_->CreateMemCpy(left_value, {}, right_value, {},
//     //   lsize);
//     // } else { // variant pattern
//     //   auto tailBlock = llvm::BasicBlock::Create(builder_->getContext(),
//     //                                             "ifTail", currentFunc);
//     //   auto trueBlock = llvm::BasicBlock::Create(builder_->getContext(),
//     //                                             "ifTrue", currentFunc);
...
//     //                                              "ifFalse", currentFunc);
//     //
//     //   // partition reachable cases into different variants
//     //   std::unordered_map<size_t, vector<u_int>>
//     //       variant_map; // variant_tag -> case_indicies
//     //
//     //   for (size_t i = 0; i < case_stmt.reachable_cases.size(); i++) {
...
//     //   auto first_variant_cases = variant_map.begin()->second;
//     //
//     //   auto right_tag_ptr =
//     //   builder_->CreateConstGEP2_32(getLLVMType(sum_type),
//     //                                                     right_value, 0,
//     0);
//     //   auto right_tag =
//     //       builder_->CreateLoad(builder_->getInt32Ty(), right_tag_ptr);
//     //
//     //   auto left_tag = builder_->getInt32(first_variant_index);
//     //
//     //   // match variant tag
//     //   auto if_condition = builder_->CreateICmpEQ(left_tag, right_tag);
//     //   builder_->CreateCondBr(if_condition, trueBlock, falseBlock);
//     //
//     //   builder_->SetInsertPoint(trueBlock);
//     //   for (auto ci : first_variant_cases) {
//     //     // TODO
//     //     // partition according to first field
//     //   }
//     //   builder_->CreateBr(tailBlock);
//     //
//     //   builder_->SetInsertPoint(falseBlock);
//     //   for (const auto &[variant_index, variant_cases] : variant_map) {
//     //     if (variant_index == first_variant_index)
...
//     //         builder_->getContext(), "elsifFalse", currentFunc);
//     //
//     //     const auto elsif_left_tag =
//     //         llvm::ConstantInt::get(builder_->getInt32Ty(), variant_index);
//     //
//     //     // match variant tag
//     //     auto elsif_condition =
//     //         builder_->CreateICmpEQ(elsif_left_tag, right_tag);
//     //     builder_->CreateCondBr(elsif_condition, elsifTrueBlock,
//     //                            elsifFalseBlock);
//     //
//     //     builder_->SetInsertPoint(elsifTrueBlock);
